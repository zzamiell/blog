        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">kelola data prestasi</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($feeds as $key => $item)
                                    <tr align="center">
                                        ...
                                        <td align="center" class="center">{{ $item->kejuaraan }}</td>
                                        <td align="center" class="center">{{ $item->tingkat }}</td>
                                        <td align="center" class="center">{{ $item->penyelenggara }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Button group">
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('prestasi.destroy', $item->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pelaksanaan"
                                                                value="{{ $item->pelaksanaan }}">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="recipient-name"
                                                                class="col-form-label">kejuaraan</label>
                                                            <input type="text" class="form-control" name="kejuaraan"
                                                                value="{{ $item->kejuaraan }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name"
                                                                class="col-form-label">penyelenggara</label>
                                                            <input type="text" class="form-control"

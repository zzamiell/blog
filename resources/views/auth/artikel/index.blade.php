        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">kelola data artikel & berita</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($feeds as $key => $item)
                                    <tr align="center">
                                        ...
                                        <td align="center" class="center">{{ $item->kategori }}</td>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="kategori" class="form-control">
                                                                <option value="BERITA"
                                                                    @if ($item->kategori == 'BERITA') selected @endif>BERITA
                                                                </option>
                                                                <option value="ARTIKEL"
                                                                    @if ($item->kategori == 'ARTIKEL') selected @endif>
                                                                    ARTIKEL</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="editKaryawan2{{ $item->id }}" name="content">{{ $item->content }}</textarea>
                                                        </div>
                                                    </div>

        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">kelola data jurusan</h6>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($feeds as $key => $item)
                                    <tr align="center">
                                        ...
                                        <td align="center" class="center"> <img src="{{ asset($item->thumbnail) }}"
                                            ...
                                            <span
                                                style="vertical-align: middle; margin-left: 10px;">{{ $item->jurusan }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Button group">
                                                ...
                                                <a href="{{ route('jurusan.galeri', $item->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $item->jurusan }}" name="jurusan">
                                                        </div>
                                                        <div class="form-group">

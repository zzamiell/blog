...
@section('title', 'Kelola Jurusan Sekolah')
...
@section('content')
                ...
                <div class="modal fade" id="deleteModal-{{ $item->id }}" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('jurusan.galeri.destroy', [$item->id, $item->jurusanId]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
    ...
    <div class="modal fade" id="addUser" role="dialog" aria-labelledby="addUserLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addUserLabel">tambah data galeri jurusan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('jurusan.store.galeri', $id) }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">

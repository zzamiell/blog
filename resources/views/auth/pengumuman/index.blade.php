...
@section('title', 'Kelola Pengumuman Sekolah')
                            ...
                            <tbody>
                                ...
                                @foreach ($feeds as $key => $item)
                                    <tr align="center">
                                        ...
                                        <td align="center" class="center"><a href="{{ asset($item->lampiran) }}">file</a>
                                        </td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('pengumuman.update', $item->id) }}" method="POST"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name"
                                                                class="col-form-label">lampiran</label>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('pengumuman.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">judul pengumuman</label>

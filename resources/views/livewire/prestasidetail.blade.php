<div data-elementor-type="single-post" data-elementor-id="364"
    class="elementor elementor-364 elementor-location-single post-770 prestasi type-prestasi status-publish has-post-thumbnail hentry kategori-prestasi-siswa">
    <div class="elementor-section-wrap">
        <section
            class="elementor-section elementor-top-section elementor-element elementor-element-bb18924 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
            data-id="bb18924" data-element_type="section" data-settings="{&quot;jet_parallax_layout_list&quot;:[]}">
            <div class="elementor-container elementor-column-gap-default">
                <div class="elementor-column elementor-col-66 elementor-top-column elementor-element elementor-element-cd06b03"
                    data-id="cd06b03" data-element_type="column">
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-7c8d621 elementor-widget elementor-widget-jet-listing-dynamic-image"
                            data-id="7c8d621" data-element_type="widget"
                            data-widget_type="jet-listing-dynamic-image.default">
                            <div class="elementor-widget-container">
                                <div class="jet-listing jet-listing-dynamic-image"><img width="640" height="426"
                                        src="{{ asset($prestasi->thumbnail) }}"
                                        class="attachment-full size-full wp-post-image" alt="{{ $prestasi->judul }}"
                                        sizes="(max-width: 640px) 100vw, 640px"></div>
                            </div>
                        </div>
                        <div class="elementor-element elementor-element-13cb314 elementor-widget elementor-widget-heading"
                            data-id="13cb314" data-element_type="widget" data-widget_type="heading.default">
                            <div class="elementor-widget-container">
                                <style>
                                ...
                                <h2 class="elementor-heading-title elementor-size-default">{{ $prestasi->judul }}</h2>
                            </div>
                        </div>
                        <div class="elementor-element elementor-element-bb3abfa elementor-icon-list--layout-inline elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                            data-id="bb3abfa" data-element_type="widget" data-widget_type="icon-list.default">
                            <div class="elementor-widget-container">
                                <ul class="elementor-icon-list-items elementor-inline-items">
                                    <li class="elementor-icon-list-item elementor-inline-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="far fa-user-circle"></i> </span>
                                        <span class="elementor-icon-list-text">Oleh : {{ $prestasi->creator }}</span>
                                    </li>
                                    <li class="elementor-icon-list-item elementor-inline-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="far fa-calendar-check"></i> </span>
                                        <span class="elementor-icon-list-text">Tanggal Posting :
                                            {{ $prestasi->created_at }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="elementor-element elementor-element-9384a45 elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                            data-id="9384a45" data-element_type="widget" data-widget_type="divider.default">
                            <div class="elementor-widget-container">
                                <style>
                                    /*! elementor - v3.21.0 - 26-05-2024 */
                        ...
                        <div class="elementor-element elementor-element-90dff42 elementor-drop-cap-yes elementor-drop-cap-view-default elementor-widget elementor-widget-text-editor"
                            data-id="90dff42" data-element_type="widget"
                        ...
                        <div class="elementor-element elementor-element-bd3b4d7 elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                            data-id="bd3b4d7" data-element_type="widget" data-widget_type="divider.default">
                            <div class="elementor-widget-container">
                                <div class="elementor-divider">
                                    <span class="elementor-divider-separator">
                                    </span>
                        ...
                        <div class="elementor-element elementor-element-30a1d0a elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                            data-id="30a1d0a" data-element_type="widget" data-widget_type="icon-list.default">
                            <div class="elementor-widget-container">
                                <ul class="elementor-icon-list-items">
                                    <li class="elementor-icon-list-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="fas fa-dot-circle"></i> </span>
                                        <span class="elementor-icon-list-text"><strong>Waktu Pelaksanaan :</strong>
                                            {{ $prestasi->pelaksanaan }}</span>
                                    </li>
                                    <li class="elementor-icon-list-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="fas fa-dot-circle"></i> </span>
                                        <span class="elementor-icon-list-text"><strong>Kejuaraan :</strong>
                                            {{ $prestasi->kejuaraan }}</span>
                                    </li>
                                    <li class="elementor-icon-list-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="fas fa-dot-circle"></i> </span>
                                        <span class="elementor-icon-list-text"><strong>Tingkat :</strong>
                                            {{ $prestasi->tingkat }}</span>
                                    </li>
                                    <li class="elementor-icon-list-item">
                                        <span class="elementor-icon-list-icon">
                                            <i aria-hidden="true" class="fas fa-dot-circle"></i> </span>
                                        <span class="elementor-icon-list-text"><strong>Penyelenggara :</strong>
                                            {{ $prestasi->penyelenggara }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="elementor-element elementor-element-49f89ba elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                            data-id="49f89ba" data-element_type="widget" data-widget_type="divider.default">
                            <div class="elementor-widget-container">
                                <div class="elementor-divider">
                                    <span class="elementor-divider-separator">
                                    </span>
                        ...
                        <section
                            class="elementor-section elementor-inner-section elementor-element elementor-element-d3f53db elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                            data-id="d3f53db" data-element_type="section"
                            ...
                            <div class="elementor-container elementor-column-gap-default">
                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-8f964c2"
                                    data-id="8f964c2" data-element_type="column">
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-b6fd43d elementor-widget elementor-widget-heading"
                                            data-id="b6fd43d" data-element_type="widget"
                                ...
                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-da5159c"
                                    data-id="da5159c" data-element_type="column">
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-c96f0d4 elementor-share-buttons--view-icon elementor-share-buttons--shape-circle elementor-share-buttons--align-right elementor-share-buttons-tablet--align-center elementor-share-buttons-mobile--align-right elementor-share-buttons--skin-gradient elementor-grid-0 elementor-share-buttons--color-official elementor-widget elementor-widget-share-buttons"
                                            data-id="c96f0d4" data-element_type="widget"
                        ...
                        <div class="elementor-element elementor-element-8b379f3 elementor-widget elementor-widget-facebook-comments"
                            data-id="8b379f3" data-element_type="widget"
                            ...
                            <div class="elementor-widget-container">
                                ...
                                <div class="elementor-facebook-widget fb-comments fb_iframe_widget fb_iframe_widget_fluid_desktop fb_iframe_widget_fluid"
                                    data-href="https://sekolah.flymotion.my.id?p=770" data-width="100%"
                                    data-numposts="10" data-order-by="social" style="min-height: 1px; width: 100%;"
                                    fb-xfbml-state="rendered"
                                    fb-iframe-plugin-query="app_id=&amp;container_width=300&amp;height=100&amp;href=https%3A%2F%2Fsekolah.flymotion.my.id%2F%3Fp%3D770&amp;locale=id_ID&amp;mobile=true&amp;numposts=10&amp;order_by=social&amp;sdk=joey&amp;version=v2.10&amp;width=">
                                    <span
                                        style="vertical-align: top; width: 100%; height: 0px; overflow: hidden;"><iframe
                                            name="ff58795413c646648" width="1000px" height="100px"
                                            data-testid="fb:comments Facebook Social Plugin"
                                            title="fb:comments Facebook Social Plugin" frameborder="0"
                                            allowtransparency="true" allowfullscreen="true" scrolling="no"
                                            allow="encrypted-media"
                                            src="https://www.facebook.com/v2.10/plugins/comments.php?app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Dface336f5bdf9fd81%26domain%3D%26is_canvas%3Dfalse%26origin%3Dfile%253A%252F%252F%252Ff59f91937ba6a2d5a%26relation%3Dparent.parent&amp;container_width=300&amp;height=100&amp;href=https%3A%2F%2Fsekolah.flymotion.my.id%2F%3Fp%3D770&amp;locale=id_ID&amp;mobile=true&amp;numposts=10&amp;order_by=social&amp;sdk=joey&amp;version=v2.10&amp;width="
                                            style="border: none; visibility: visible; width: 0px; height: 0px;"></iframe></span>
                                </div>
                            </div>
                        </div>
                        <div class="elementor-element elementor-element-3f867ef elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                            data-id="3f867ef" data-element_type="widget" data-widget_type="divider.default">
                            <div class="elementor-widget-container">
                                <div class="elementor-divider">
                                    <span class="elementor-divider-separator">
                                    </span>
